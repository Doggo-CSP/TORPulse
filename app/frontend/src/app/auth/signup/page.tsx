    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f5f0e8] px-4 py-10">
      <div className="w-full max-w-[420px]">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-[#e8e0d0] p-8">
          ...
          <h1 className="text-2xl font-bold text-[#2d2d2d] mb-2">สมัครสมาชิก</h1>
          <p className="text-sm text-[#7a8b6f] leading-relaxed mb-7">
            เริ่มต้นใช้งานฟรี สร้างโปรไฟล์บริษัทและรับการแนะนำ<br />
            TOR ที่ตรงกับความสามารถของทีมคุณ
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className={`w-full rounded-xl border px-4 py-3 text-sm text-[#2d2d2d] placeholder:text-[#b0a898] outline-none focus:ring-2 transition-all pr-11 ${
                    !passwordsMatch
                      ? "border-red-400 bg-red-50 focus:border-red-400 focus:ring-red-400/15"
                      : "border-[#ddd5c8] bg-[#faf7f2] focus:border-[#4a7c59] focus:ring-[#4a7c59]/15"
                  }`}
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="mt-1 w-full rounded-xl bg-[#4a7c59] py-3 text-sm font-semibold text-white hover:bg-[#3d6b4a] active:scale-[0.98] transition-all duration-150 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
              สร้างบัญชี
            </button>
          </form>
          ...
          {/* Terms notice */}
          <p className="mt-4 text-center text-[11px] text-[#b0a898] leading-relaxed">
            การสมัครถือว่าคุณยอมรับ{" "}
            <Link href="/terms" className="underline hover:text-[#7a8b6f]">
              เงื่อนไขการใช้งาน
            </Link>{" "}
            และ{" "}
            <Link href="/privacy" className="underline hover:text-[#7a8b6f]">
              นโยบายความเป็นส่วนตัว
            </Link>
          </p>

          {/* Login link */}
          <p className="mt-5 text-center text-sm text-[#7a8b6f]">
            มีบัญชีอยู่แล้ว?{" "}
            <Link
              href="/auth"
